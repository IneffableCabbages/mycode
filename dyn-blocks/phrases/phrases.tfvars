upload_content = [
  ...
  { content = "My Cabbages! (created via our dynamic block)", file = "/terraform/test3.txt", executable = true },
  { content = "Don't Panic", file = "/terraform/test4.txt", executable = true },
]
